...
namespace KerbalEngineer.Control
{
    ...
    public class ControlCentre : MonoBehaviour
    {
        ...
        protected void OnGUI()
        {
            ...
            {
                GUI.skin = null;
                this.position = GUILayout.Window(this.GetInstanceID(), this.position, this.Window, "KERBAL EggINEER REDUX " + EngineerGlobals.ASSEMBLY_VERSION + "p - CONTROL CENTRE", HighLogic.Skin.window);
                this.CentreWindow();
            }
            catch (Exception ex)
            {
